  ...
  return (
    <div className="hero-container container">
      <div className="leading-texts">
        <h3 className="lead-title">Invest in Coldroom Business with Devine Cooling</h3>
        <p className="lead-desc">
          We are Devine Cooling. We build Cooling machines and install them for
          cold-room businesses. We also give advice on how to manage a cold room business.
      ...
      <div className="leading-img">
        <img className="hero-leading-img" src={heroLeadImage} alt="This is the hero image" />
      </div>
    </div>
  );
};
